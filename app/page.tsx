					...
					>
						...
						<div className=''>
							<p className='text-lg leading-relaxed'>
								...
								30.08.2025 от Ледового дворца г. Орши ориентировочно в
						...
						<div className=''>
							<p className='text-lg leading-relaxed'>
								...
								пожалуйста, заранее подумайте о проживании и дороге до г. Орши.
						...
						<div className=''>
							<p className='text-lg leading-relaxed'>
								• В воскресенье, 31.08.2025, в г. Орше будет организован
			...
			<section id='rsvp' className='w-full py-16 px-6 bg-paper'>
				<div className='max-w-md mx-auto text-center space-y-8 pb-8'>
					...
					>
						...
						подтвердите свое присутствие до 01.07.2025, заполнив форму ниже.
					</p>
