...
export function RSVPForm() {
  ...
  const handleCheckboxChange = (value: string, checked: boolean) => {
    setFormData((prev) => {
      if (checked) {
        return { ...prev, alcoholPreferences: [...prev.alcoholPreferences, value] }
      } else {
        return { ...prev, alcoholPreferences: prev.alcoholPreferences.filter((item) => item !== value) }
      }
    })
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-md mx-auto text-left space-y-6">
      ...
      <div className="space-y-2">
        ...
        <Input id="phone" name="phone" value={formData.phone} onChange={handleChange} required className="text-base" />
      </div>

      <div className="space-y-2">
        <Label className="text-base">Вы сможете присутствовать на мероприятии?</Label>
        <RadioGroup
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleCheckboxChange("champagne", checked === true)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleCheckboxChange("white-wine", checked === true)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleCheckboxChange("red-wine", checked === true)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleCheckboxChange("vodka", checked === true)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleCheckboxChange("cognac", checked === true)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleCheckboxChange("whiskey", checked === true)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleCheckboxChange("no-alcohol", checked === true)}
                />
      ...
      <Button type="submit" className="w-full bg-neutral-900 hover:bg-neutral-800 text-base">
        Отправить
      </Button>
    </form>
  )
